    ...
    <Container className='detail-keluhan' style={{marginTop:'50px'}}>
        <Row>
          <Col style={{textAlign:'center'}}>
            <img style={{ width: "250px", height: "250px", borderRadius: "10px", objectFit:'cover', textAlign:'center', marginBottom:'30px' }} src={props.fotoSebelum} className="fotoSebelum" alt="fotoSebelum" />
          </Col>
        </Row>
        <Row>
          <Col xs="auto">
          ...
          <Col xs="auto" style={{marginLeft:"auto", paddingTop:"7px", fontSize:"20px"}}>
            <span>
